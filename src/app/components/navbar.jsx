      ...
      children: [
        {
          ...
          children: [
            ...
            { label: "Dry Skin", href: "/acuteailments/skinailments/dryskin" },
            { label: "Acne And Pimples", href: "/acuteailments/skinailments/acneandpimples" },
            { label: "Black Discoloration on Face", href: "/acuteailments/skinailments/blackdiscolorationonface" },
            { label: "Alopecia Areata", href: "/acuteailments/skinailments/alopeciaareata" },
            { label: "Warts", href: "/acuteailments/skinailments/warts" },
            { label: "Corn", href: "/acuteailments/skinailments/corn" },
            { label: "Vitilligo", href: "/acuteailments/skinailments/vitilligo" },
            { label: "Heat Storks", href: "/acuteailments/skinailments/heatstorks" },
            { label: "Sun Burns", href: "/acuteailments/skinailments/sunburns" },
            { label: "Skin Rashes", href: "/acuteailments/skinailments/skinrashes" },
            { label: "Varicose Veins", href: "/acuteailments/skinailments/varicoseveins" },
          ],
        },
        {
