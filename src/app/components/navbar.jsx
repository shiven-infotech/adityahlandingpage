    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            { label: "Hair Loss", href: "/acuteailments/beautyailments/hairlosshomoeopathytreatment" },
            { label: "Greying of Hair", href: "/acuteailments/beautyailments/greyingofhairhomoeopathytreatment" },
            { label: "Dandruff", href: "/acuteailments/beautyailments/dandruffhomoeopathytreatment" },
            { label: "Freckles", href: "/acuteailments/beautyailments/freckleshomoeopathytreatment" },
            { label: "Dark Circles Under Eyes", href: "/acuteailments/beautyailments/darkcirclesundereyeshomoeopathytreatment" },
            { label: "Pimples", href: "/acuteailments/beautyailments/pimpleshomoeopathytreatment" },
            { label: "Ear Infection", href: "/acuteailments/beautyailments/earinfectionhomoeopathytreatment" },
            { label: "Conjunctivits", href: "/acuteailments/beautyailments/conjunctivitshomoeopathytreatment" },
            { label: "Vision Improvement", href: "/acuteailments/beautyailments/visionimprovementhomoeopathytreatment" },
          ],
        },
        { label: "Bone Ailments", href: "/acuteailments/boneailments",
          children: [
            { label: "Cervical Spondylosis", href: "/acuteailments/boneailments/cervicalspondylosishomoepathytreatment" },
            { label: "Lumbar Spondylosis", href: "/acuteailments/boneailments/lumbarspondylosishomoepathytreatment" },
            { label: "Gout", href: "/acuteailments/boneailments/gouthomoepathytreatment" },
            { label: "Sciatica", href: "/acuteailments/boneailments/sciaticahomoepathytreatment" },
            { label: "Spinal Stenosis", href: "/acuteailments/boneailments/spinalstenosishomoepathytreatment" },
            { label: "Degenerative Changes", href: "/acuteailments/boneailments/degenerativechangeshomoepathytreatment" },
            { label: "Joint pain", href: "/acuteailments/boneailments/jointpainhomoepathytreatment" },
            { label: "Rheumatism", href: "/acuteailments/boneailments/rheumatismhomoepathytreatment" },
