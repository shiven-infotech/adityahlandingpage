    ...
    <>
      ...
      <section className="max-w-screen mx-auto bg-[#e3ffe0] px-6 py-8 space-y-12">
        ...
        <div className="flex justify-center" data-aos="fade-up" data-aos-delay="600">
          <div className="p-6 flex flex-col items-center justify-center text-center   max-w-lg">
            <h2 className="text-2xl font-semibold text-green-700 mb-2">
              Start Your Journey to Lasting Relief
            </h2>
            <p className=" mb-4 leading-relaxed">
              You don’t have to live with chronic illness controlling your life.
              With the right homeopathic care, you can move toward lasting
              relief, better energy, and improved overall well-being. Every step
              you take toward natural healing brings you closer to a healthier,
              more vibrant future. Begin your journey today — we’re here to
