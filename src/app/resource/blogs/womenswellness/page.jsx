...
export default function WomensWellnessPage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="bg-pink-100 py-16 px-6 text-center" data-aos="fade-up">
      ...
      <section className="py-16 px-6 bg-white" data-aos="fade-up">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <img
              src="/images/womens-wellness.jpg"
      ...
      {/* Conditions Section */}
      <section className="py-16 px-6 bg-pink-50" data-aos="fade-up">
      ...
      {/* Call to Action */}
      <section className="py-16 px-6 bg-pink-100 text-center" data-aos="fade-up">
