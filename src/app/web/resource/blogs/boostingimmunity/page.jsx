...
export default function BoostingImmunityPage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section
        className=" bg-[#e3ffe0] py-6 px-6 text-center"
        data-aos="fade-up"
      >
        ...
        <p className="text-lg max-w-3xl mx-auto">
          Discover how homeopathy strengthens your body’s natural defense
          system and keeps you healthier, naturally and safely.
        </p>
      </section>

      {/* Intro Section */}
      <section
        className="max-w-screen mx-auto bg-[#e3ffe0] py-12 px-6 grid md:grid-cols-2 gap-10 items-center"
        data-aos="fade-right"
      >
        <div>
          ...
          <p className="text-lg mb-4">
            ...
            infections and diseases. A strong immune system not only protects
            you from seasonal illnesses but also enhances your energy, mood,
            and overall well-being.
          </p>
          <p className="text-lg">
            Homeopathy focuses on balancing and stimulating the body’s innate
            healing abilities, making it a natural choice for boosting immunity
      ...
      <section className="bg-[#e3ffe0] py-12 px-6" data-aos="fade-up">
        <div className="max-w-screen mx-auto text-center">
          <h2 className="text-3xl font-bold text-green-700 mb-8">
            Benefits of Homeopathy for Immunity
          </h2>
          <div className="grid md:grid-cols-3 gap-8 text-left">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p>
                Homeopathic remedies are derived from natural sources, making
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p>
                Boost your immunity without worrying about harmful chemical
                side effects.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p>
                Treatments are tailored to your specific health profile and
                needs.
              </p>
            </div>
          </div>
      ...
      <section
        className="max-w-8xl mx-auto bg-[#e3ffe0] py-12 px-8 grid md:grid-cols-2 gap-10 items-center"
        data-aos="fade-left"
      >
        <div>
          <img
